...
namespace LicenseProject.Controllers
{
    public class RestaurantsController : Controller
    {
        ...
        public IActionResult List(int id)
        {
            ...
            if (id == 0)
            {
                restaurants = _context.Restaurants.OrderBy(n => n.RestaurantId).ToList();
            ...
            else
            {
                if (_category == 1)
                {
                    restaurants = _context.Restaurants.Where(p => p.RestaurantsCategories.FirstOrDefault(c=>c.CategoryId==1).CategoryId==1).ToList();
                ...
                {
                    restaurants = _context.Restaurants.Where(p => p.RestaurantsCategories.Equals(2)).ToList();
